...
void Transmit_CAN0_ISR();
void Transmit_CAN1_ISR();
void Transmit_CAN2_ISR();
void Transmit_CAN3_ISR();
void Transmit_CAN4_ISR();
void Receive_CAN0_ISR ();
void Receive_CAN1_ISR();
void Receive_CAN2_ISR();
void Receive_CAN3_ISR();
void Receive_CAN4_ISR();
void Wakeup_CAN0_ISR();
void Wakeup_CAN1_ISR();
void Wakeup_CAN2_ISR();
void Wakeup_CAN3_ISR();
void Wakeup_CAN4_ISR();
void Err_CAN0_ISR();
void Err_CAN1_ISR();
void Err_CAN2_ISR();
void Err_CAN3_ISR();
