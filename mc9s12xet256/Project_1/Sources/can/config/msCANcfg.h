...
// Symbol Definitions -------------------------------
/* Here difine the name of the used MCU equiped with msCAN module*/
#define MC9S12XET256MAA

// MC9S12XET256MAA MSCAN Module Definition ---------------------------
/* Define MSCAN channel number and channels used */
#ifdef MC9S12XET256MAA
#define MSCAN0
#define MSCAN1
#define MSCAN2
#define MSCAN3
...
* Set different Prescaler for all CAN Channels, in case the Oscillator Frequency is 16M
* Note: User can carefully change this part to get different bitrate
******************************************************************************/
#define PRESCALER_CAN0          (8)	   // 125kbps, if CANBTR0 AND CANBTR1 IN the driver not changed
#define PRESCALER_CAN1          (8)	   // 125kbps, if CANBTR0 AND CANBTR1 IN the driver not changed
#define PRESCALER_CAN2          (1)	   // 1mbps,   if CANBTR0 AND CANBTR1 IN the driver not changed
#define PRESCALER_CAN3          (2)	   // 500kbps, if CANBTR0 AND CANBTR1 IN the driver not changed;
#define PRESCALER_CAN4          (2)	   // 500kbps, if CANBTR0 AND CANBTR1 IN the driver not changed;

/******************************************************************************
* Define msCAN module bit timing
*
* Permitted values: TIME_SEG1_CANx: 1 to 16 time quanta
*                   TIME_SEG2_CANx: 1 to 8 time quanta
* Bit time = (1 + TIME_SEG1_CANx + TIME_SEG2_CANx) * time quanta
* Note: User can carefully change this part to get different bitrate
******************************************************************************/
...
#define TIME_SEG2_CAN0          (2)
#define TIME_SEG2_CAN1          (2)
#define TIME_SEG2_CAN2          (2)
#define TIME_SEG2_CAN3          (2)
...
* Permitted values: TRUE:  3 samples per bit (TIME_SEG1_CAN >= 2)
...
#define CANCTL1_CAN1 ((CANENABLE_CAN1 << 7)|(WU_FILTER_CAN1 << 2)|(LISTEN_CAN1 << 4)|(CLKSRC_CAN1 << 6))
#define CANCTL1_CAN2 ((CANENABLE_CAN2 << 7)|(WU_FILTER_CAN2 << 2)|(LISTEN_CAN2 << 4)|(CLKSRC_CAN2 << 6))
#define CANCTL1_CAN3 ((CANENABLE_CAN3 << 7)|(WU_FILTER_CAN3 << 2)|(LISTEN_CAN3 << 4)|(CLKSRC_CAN3 << 6))
#define CANCTL1_CAN4 ((CANENABLE_CAN4 << 7)|(WU_FILTER_CAN4 << 2)|(LISTEN_CAN4 << 4)|(CLKSRC_CAN4 << 6))
